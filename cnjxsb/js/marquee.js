function dmarquee(lineheight, speed, delay, id) {		
	...
	var h1 = Number(document.getElementById(id).style.height.replace('px', '')); 
	var h2 = document.getElementById(id+'_tmp').scrollHeight;
	console.log("h1:"+h1+" h2:"+h2);
	if(lineheight == -1) return;
	if(h2*2 <= h1) { 
		this.o.innerHTML = this.h; return; 
	}else if(h2 >= h1) { 
...
//e.g. new dmarquee(20, 20, 1000, 'id'); id的高度必须要设定
